...
{
    public partial class FormularioBuenEstado
    {
        #region Variables
        [CascadingParameter]
        ...
        public List<DetalleFacturaModel> ListaDePedidosData = new List<DetalleFacturaModel>();
        public List<DetalleFacturaModelDTO> ListaPedidos = new List<DetalleFacturaModelDTO>();
        public List<DetalleFacturaModelDTO> Detalle = new List<DetalleFacturaModelDTO>();
        // private DetalleFacturaModelDTO DetalleItem;
        public List<DireccionesModel> Direccion = new List<DireccionesModel>();
        public List<FormularioModel> Campos = new List<FormularioModel>();
        ...
        {
            bool prompt = await DialogService.ConfirmAsync("¿Esta seguro/a de crear la devolucion en buen estado?");
            if (prompt)
            {
        ...
        private async void onEnterPress(KeyboardEventArgs args)
        {
            if (args.Key == "Enter" && _NroFactura.Length > 2)
            {
                ...
                if (Campos.Count >0 )
                {
                    ...
                    {
                        if (item.TipoDireccion.Contains("B"))
                        {
                            Direccion.Add(item);
                        }
                    }
        ...
        //{
        //    if (_NroFactura.Length > 2)
        //    {
        //        MudTextNroFactura.Disabled = true;
        //        StateHasChanged();
        //        snakBarCreation("Buscando...", Defaults.Classes.Position.BottomStart, Severity.Info, 6000);
        //        if (_NroFactura == "123123123")
        //        {
        //            await Task.Delay(3000);
        //            snakBarCreation("Factura encontrada", Defaults.Classes.Position.BottomStart, Severity.Success, 3000);
        //            _FechaDeCompra = "22/22/2222";
        //            _RutCliente = "19058257-4";
        //            _NombreCliente = "Frederick Cid";
        //            _Telefono = "949038963";
        //            _Correo = "fcid@andesindustrial.cl";
        //            _Total = "2.522.554";
        //            ListaPedidos = ListaDePedidosData;
        //            MudTextNroFactura.Disabled = false;
        //            StateHasChanged();
        ...
        //            _Correo = "";
        //            _Total = "";
        //            ListaPedidos = new List<DetalleFacturaModel>();
        //            MudTextNroFactura.Disabled = false;
        //            StateHasChanged();
        //        }
        //    }
        ...
        void CommittedItemChanges(DetalleFacturaModelDTO args)
        {
            ...
            {
                args.Cantidad = 1;
                snakBarCreation("No puede ser 0", Defaults.Classes.Position.BottomStart, Severity.Warning, 5000);
