...
{
    public partial class ImpresionArticuloFoto
    {
        ...
        int Copias;
        string url = "/api/v2/ImpresionEtiquetas/ImpresionArticuloDetalle/";
        public string SelectedOption { get; set; } = "Con QR";
        ...
        public async Task Imprimir()
        {
            ...
            if (form.IsValid)
            {
                ...
                var result = await service.ConectionService.HttpClientInstance.GetAsync($"{url}{IDArtiuclo}/{Impresora}/{SelectedOption}/{Copias}");
