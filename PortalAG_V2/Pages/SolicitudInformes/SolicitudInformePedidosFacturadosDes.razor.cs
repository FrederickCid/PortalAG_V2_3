...
{
    public partial class SolicitudInformePedidosFacturadosDes
    {
        SfGrid<informeFacturaDespachoModel> Grid;
        ...
        string UrlHistoricos = "informeFactura/EstadoDespacho";
        private List<informeFacturaDespachoModel> Diferencias = new List<informeFacturaDespachoModel>();
        ...
        public async Task CargarDatos(string inicio, string fin)
        {
            try
            {
                ...
                {
                    Diferencias = JsonConvert.DeserializeObject<List<informeFacturaDespachoModel>>(await lista.Content.ReadAsStringAsync());
                    Loading = false;
                ...
                {
                    Loading = false;
                    Diferencias = new List<informeFacturaDespachoModel>();
